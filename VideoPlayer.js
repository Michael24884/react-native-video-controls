...
export default class VideoPlayer extends Component {
  ...
  constructor(props) {
    ...
    this.events = {
      ...
      onFastRewind: this.props.onFastRewind,
    };
    ...
    this.methods = {
      ...
      fastRewind: this._fastRewind.bind(this),
  ...
  _fastForward() {
    ...
    typeof this.events.onFastForward === 'function' && this.events.onFastForward();
  }
  
  _fastRewind() {
    typeof this.events.onFastRewind === 'function' && this.events.onFastRewind();
  ...
  renderCenterControls() {
    ...
    const skipFControl = this.renderForward();
    const rewindFControl = this.renderRewind();
...
//      {skipFControl}
  ...
  renderPlayPause() {
    ...
    //     : require('./assets/img/pause.png');
          ...
          return this.renderControl(
            <Icon type={"MaterialCommunityIcons"} name={this.state.paused === true ? "play" : "pause"} color={"white"} size={50}/>,
            this.methods.togglePlayPause,
